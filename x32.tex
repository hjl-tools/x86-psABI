...
\item[\textindex{Initial Exec Model, II}]
  ...
  operand can't be used for x32 since the effective address will be
...
\begin{table}[H]
\Hrule
\caption{Initial Exec Model Code Sequence With Lea}
\begin{center}
\code\small{
\begin{tabular}{lll|lll}
\multicolumn{3}{c}{LP64} & \multicolumn{3}{c}{X32} \\
...
\begin{table}[H]
\Hrule
\caption{Initial Exec Model Code Sequence with Add}
\begin{center}
\code\small{
\begin{tabular}{lll|lll}
\multicolumn{3}{c}{LP64} & \multicolumn{3}{c}{X32} \\
