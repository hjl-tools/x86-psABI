...
\code{__float128}, \code{__m64}, \code{__m128} and \code{__m256} types
are optional.  
...
{ % Use small here - the table is still too large
  ...
  \begin{tabular}{l|l|c|c|l}
    ...
    \cline{2-5}
    & \texttt{long long} & 8 &
	8$^{\dagger\dagger\dagger\dagger\dagger}$ & signed \eightbyte \\
    & \texttt{signed long long} & & \\
    \cline{2-5}
    & \texttt{unsigned long long} & 8
	& 8$^{\dagger\dagger\dagger\dagger\dagger}$ & unsigned \eightbyte \\
    \cline{2-5}
	...
	& 8$^{\dagger\dagger\dagger\dagger\dagger}$ & double (IEEE-754) \\
    \cline{2-5}
    & \texttt{__float80}$^{\dagger\dagger}$  & 16 & 16 & 80-bit extended (IEEE-754) \\
    & \texttt{long double}$^{\dagger\dagger\dagger\dagger}$  & 16 & 16 & 80-bit extended (IEEE-754) \\
    & \texttt{long double}$^{\dagger\dagger\dagger\dagger}$ & 8
	& 8$^{\dagger\dagger\dagger\dagger\dagger}$ & double (IEEE-754) \\
    \cline{2-5}
...
that order.}\\
\multicolumn{5}{p{14cm}}{\small $^{\dagger\dagger\dagger\dagger}$ The
\texttt{long double} type is 64-bit, the same as the \texttt{double} type,
on the Android{\texttrademark} platform.  More information on the
