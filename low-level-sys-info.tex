...
Empty type is defined as
\begin{enumerate}
\item Class type is a structure, union or C++ class.
\item Empty type is Plain Old Data (POD) for the purpose of layout,
  and a type where it and all of its subobjects are of class or array
  type.
\end{enumerate}
