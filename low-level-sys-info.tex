...
\item \texttt{Empty type} is defined as a trivially-copyable aggregate
...
object of \texttt{empty type} \footnote{Array of \texttt{empty type} can
only passed by reference in C and C++.}.
