...
\begin{enumerate}
  \item When loading an executable, if
...
\begin{enumerate}
  \item When loading an executable,
    if \code{GNU_PROPERTY_X86_FEATURE_1_SHSTK} is set on the executable
    as well as all shared objects loaded via the \code{DT_NEEDED} tags,
    enable SHSTK.
