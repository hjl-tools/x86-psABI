...
of the \texttt{STT_GNU_IFUNC} symbol\footnote{If the returned function
has non-local binding, the run-time behavior is undefined as it may
be preempted at run-time.}.
