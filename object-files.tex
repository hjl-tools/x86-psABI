...
\Hrule
  ...
  \begin{center}
    \begin{tabular}[t]{l|r|l|l}
      ...
      \texttt{R_X86_64_PC32_BND}  & 39 & \textit{word32} & \texttt{S + A - P} \\
      \texttt{R_X86_64_PLT32_BND} & 40 & \textit{word32} & \texttt{L + A - P} \\
...
\texttt{R_X86_64_PC32_BND} is similar to \texttt{R_X86_64_PC32}, except
that it is applied to branch instructions with the \texttt{BND}
(\code{0xf2}) prefix.

\texttt{R_X86_64_PLT32_BND} is similar to \texttt{R_X86_64_PLT32}. except
that it is applied to branch instructions with the \texttt{BND}
(\code{0xf2}) prefix.
