...
\renewcommand{\PrelimWords}{AMD64 ABI \version}

% Some commands:
\newcommand{\editornote}[1]{\footnote{#1}}

%Typesetting of registers
\newcommand{\reg}[1]{{\texttt{\myfontsize{\%#1}}}\xspace}
...
\newcommand{\code}[1]{\texttt{\myfontsize{#1}}\xspace}
...
\ifpdf
\usepackage[pdftex,colorlinks,linkcolor={blue!50!black},final]{hyperref}
...
% some debug settings to show margins and mark overfulls
