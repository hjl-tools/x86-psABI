...
\begin{description}
 \item[GNU_PROPERTY_X86_UINT32_AND_LO..GNU_PROPERTY_X86_UINT32_AND_HI]
   ...
   all relocatable input \code{pr_data} fields.
 \item[GNU_PROPERTY_X86_UINT32_OR_LO..GNU_PROPERTY_X86_UINT32_OR_HI]
   ...
   relocatable input \code{pr_data} fields.
...
\begin{description}
 ...
 \item[GNU_PROPERTY_X86_ISA_1_USED] The x86 instruction sets indicated
   ...
   \code{GNU_PROPERTY_X86_FEATURE_2_USED} type is also present,
\end{description}
...
from the older linkers.} is defined for the \code{pr_data} field for all
properties:
...
Linker should set the \code{GNU_PROPERTY_X86_UINT32_VALID} bit in
the \code{pr_data} field for all properties in non-relocatable outputs.
